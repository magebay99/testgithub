...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Magebay_Marketplace::manage_products')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
        ...
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('category_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'products_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'products_content');
                }
            };
        ";
